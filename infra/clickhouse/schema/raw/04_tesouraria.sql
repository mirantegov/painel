...
(
    ...
    cadastradaaria014015016017018XX Nullable(String),
    idPessoa_2 Nullable(String),
    idContaBACEN_2 Nullable(String),
    nrCPF_2 Nullable(String),
    dtInicio Nullable(String),
    dtBaixa Nullable(String),
    idTipoBaixaResponsavel Nullable(String),
    dsMotivo Nullable(String),
    _id_entidade   Nullable(String),
    _exercicio     Nullable(String),
    _competencia   Nullable(String),
...
(
    ...
    nrDocumentoocumento Nullable(String),
...
(
    ...
    idOperacaoConta Nullable(String),
    nrAnoOperacaoConta Nullable(String),
    nrSequencialEstornoEstorno Nullable(String),
    _id_entidade   Nullable(String),
    _exercicio     Nullable(String),
    _competencia   Nullable(String),
    _fonte         LowCardinality(String) DEFAULT '',
