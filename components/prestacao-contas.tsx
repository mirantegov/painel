...
import {
  ...
  type GrupoCAUC,
  type ParecerTCE,
} from "@/lib/demo-prestacao-contas";
...
function EvolucaoCAUCChart({
  ...
  historicoCAUC: typeof CONTAS_SNAPSHOT.historicoCAUC;
}) {
  return (
    <Card>
      <CardHeader>
...
function EvolucaoAgendaChart({
  ...
  historicoAgenda: typeof CONTAS_SNAPSHOT.historicoAgenda;
}) {
  return (
    <Card>
      <CardHeader>
...
export function PrestacaoContas() {
  const {
    ...
    certidaoAtual,
    historicoCertidao,
  } = useSnapshot("prestacao-contas", CONTAS_SNAPSHOT);
            ...
            <Tabs defaultValue="extrato" className="space-y-4">
              ...
              <TabsContent value="extrato" className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex gap-1">
                    <Button
                      variant={
                        filtroSituacao === "todos" ? "default" : "outline"
                      }
                      size="sm"
              ...
              <TabsContent value="historico" className="space-y-4">
                <div className="grid gap-4 lg:grid-cols-2">
                  <EvolucaoCAUCChart historicoCAUC={historicoCAUC} />
                  <ConformidadePorGrupoChart gruposCAUC={gruposCAUC} />
                </div>
                ...
                <>
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Histórico de julgamento das contas anuais pelo Tribunal
        ...
        {canSee("agenda") && (
          <TabsContent value="agenda" className="space-y-6">
            ...
            <Tabs defaultValue="matriz" className="space-y-4">
                      ...
                      <Table>
                        <TableHeader>
                          <TableRow>
                            ...
                            <TableHead>
                              Descrição do Item não Atendido
                            </TableHead>
              ...
              {/* Tab: Histórico */}
              <TabsContent value="historico" className="space-y-4">
                <EvolucaoAgendaChart historicoAgenda={historicoAgenda} />
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      <HugeiconsIcon
                ...
                <>
                  ...
                  {isPendente && (
                    <Alert variant="destructive">
                      ...
                      <AlertDescription>
                        Balancete contábil pendente há {entidadeMSC.mesesAtraso}{" "}
                        meses. Competência esperada:{" "}
                        {entidadeMSC.competenciaEsperada}. Regularize o envio da
                        MSC no portal SICONFI para evitar restrições no CAUC.
                      </AlertDescription>
                    </Alert>
                  )}
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  {dadosMSC.totalEntidades} entidade(s)
                                  monitorada(s) — SICONFI
                                </p>
                              </div>
                            </div>
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <div className="flex flex-wrap gap-2 mb-6">
                            ...
                            <Badge variant="outline" className="text-xs">
                              Última entrega: {entidadeMSC.ultimaCompetencia}
                            </Badge>
                          </div>
                  ...
                  {isVencendoEmBreve && isApto && (
                    <Alert className="border-amber-500 bg-amber-50 text-amber-900 dark:bg-amber-950 dark:text-amber-200">
                      ...
                      <AlertDescription>
                        ...
                        {certidaoAtual.diasRestantes} dias (
