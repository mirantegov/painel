      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Indicadores consolidados da gestão de pessoas
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Benchmark regional: {formatCurrency(10250)}
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Progress
                  value={(limitePessoalLRF.percentualAtual / 54) * 100}
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Insights sobre a gestão de pessoas e folha de pagamento
                  municipal
                </CardDescription>
              </div>
            </div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="prose prose-sm dark:prose-invert max-w-none">
              <p className="text-foreground leading-relaxed">
                A análise da gestão de recursos humanos do município no
                exercício de {periodoSelecionado} revela um quadro de
                <strong> {totalFuncionarios} servidores</strong> com folha
                líquida de{" "}
                <strong>{formatMillions(dadosFolha.salarioLiquido)}</strong>. A
                despesa com pessoal representa{" "}
                <strong>{limitePessoalLRF.percentualAtual}% da RCL</strong>,
                dentro do limite legal de 54% mas acima do limite de alerta de
                48.6%. O absenteísmo de <strong>4.3%</strong> e o turnover de{" "}
                <strong>8.5%</strong> estão abaixo da média regional, indicando{" "}
                <strong>boa retenção e engajamento</strong> dos servidores.
              </p>
            </div>
                ...
                <AccordionContent>
                  <div className="space-y-3 pl-6">
                    <div className="flex gap-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        <strong className="text-foreground">
                          Horas extras acima do orçado:
                        </strong>{" "}
                        O gasto com horas extras de{" "}
                        {formatCurrency(dadosFolha.horasExtras)} supera o limite
                        orçamentário em 27.8%. As secretarias de Saúde e Obras
                        concentram 65% desse gasto, indicando necessidade de
                        adequação do quadro nesses setores.
                      </p>
                    </div>
                    <div className="flex gap-2">
                      <HugeiconsIcon
                      ...
                      <p className="text-sm text-muted-foreground">
                        <strong className="text-foreground">
                          Custo médio competitivo:
                        </strong>{" "}
                        O custo médio por funcionário de
                        {formatCurrency(
                          Math.round(totalSalarios / totalFuncionarios),
                        )}{" "}
                        está abaixo da média regional de R$ 10.250, demonstrando
                        eficiência na gestão da folha.
                      </p>
                    </div>
                    <div className="flex gap-2">
                      <HugeiconsIcon
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        Os descontos obrigatórios (INSS + IRRF) representam{" "}
                        {(
                          ((dadosFolha.inss + dadosFolha.irrf) /
                            (dadosFolha.salarioBase +
                              dadosFolha.horasExtras +
                              dadosFolha.adicionais)) *
                          100
                ...
                <AccordionContent>
                  <div className="space-y-3 pl-6">
                    <div className="flex gap-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        <strong className="text-foreground">
                          Proximidade do limite de alerta:
                        </strong>{" "}
                        A despesa com pessoal de{" "}
                        {limitePessoalLRF.percentualAtual}% da RCL está a apenas{" "}
                        {(51.3 - limitePessoalLRF.percentualAtual).toFixed(1)}pp
                        do limite prudencial (51.3%). Nos últimos 7 trimestres,
                        o percentual cresceu de 44.2% para 46.0%.
                      </p>
                    </div>
                    <div className="flex gap-2">
                      <HugeiconsIcon
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        de margem até o limite máximo. Recomenda-se cautela na
                        concessão de reajustes e novas contratações até que a
                        receita corrente líquida apresente crescimento
                        sustentável.
                      </p>
                    </div>
                    <div className="flex gap-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        Apesar da tendência de alta, o município ainda se mantém
                        dentro do limite máximo de 54% estabelecido pela Lei de
                  ...
                  <div className="space-y-3 pl-6">
                    <div className="flex gap-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        A taxa de turnover de 8.5% está abaixo da média regional
                        de 10.7%, indicando boa retenção de talentos. A
                        estabilidade do quadro contribui para a continuidade dos
                        serviços públicos.
                      </p>
                    </div>
                    <div className="flex gap-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        <strong className="text-foreground">
                          Absenteísmo setorial preocupante:
                        </strong>{" "}
                        Embora a taxa geral de 4.3% esteja próxima da meta
                        (4.0%), a Secretaria de Saúde apresenta 7.8%, quase o
                        dobro da meta. Recomenda-se investigação das causas e
                    ...
                    <div className="flex gap-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        {totalParticipantes} servidores (
                        {(
                          (totalParticipantes / totalFuncionarios) *
                          100
                        ).toFixed(0)}
                        % do quadro) participaram de programas de capacitação,
                        com investimento de{" "}
                        {formatCurrency(totalInvestimentoCapacitacao)}. A média
                        de
                        {(totalHorasCapacitacao / totalFuncionarios).toFixed(1)}
                        h/funcionário está abaixo da meta de 40h/ano.
                      </p>
                    </div>
                  </div>
                </AccordionContent>
                  ...
                  <div className="space-y-3 pl-6">
                    <div className="rounded-lg border bg-amber-50/50 dark:bg-amber-950/20 p-3">
                      <p className="text-sm font-medium text-foreground mb-1">
                        1. Controlar crescimento da folha
                      </p>
                      <p className="text-xs text-muted-foreground">
                        Estabelecer política de contenção de horas extras,
                        priorizando a adequação do quadro nas secretarias com
                        maior gasto. Considerar concurso para suprir as{" "}
                        {totalVagas} vagas em aberto, reduzindo a dependência de
                        horas extras.
                      </p>
                    </div>
                    <div className="rounded-lg border bg-amber-50/50 dark:bg-amber-950/20 p-3">
                      <p className="text-sm font-medium text-foreground mb-1">
                        2. Planejar sucessão de aposentadorias
                      </p>
                      <p className="text-xs text-muted-foreground">
                        Iniciar programa de gestão do conhecimento para os{" "}
                        {totalAposentadorias5Anos} servidores com previsão de
                        aposentadoria nos próximos 5 anos ({percentualQuadro}%
                        do quadro), priorizando Professores e profissionais de
                        Saúde.
                      </p>
                    </div>
                    <div className="rounded-lg border bg-amber-50/50 dark:bg-amber-950/20 p-3">
                      <p className="text-sm font-medium text-foreground mb-1">
                        3. Combater absenteísmo na Saúde
                      </p>
                      <p className="text-xs text-muted-foreground">
                        Implementar programa de qualidade de vida e saúde
                        ocupacional na Secretaria de Saúde, que apresenta taxa
                        de absenteísmo de 7.8%, quase o dobro da meta de 4%.
                      </p>
                    </div>
                    <div className="rounded-lg border bg-green-50/50 dark:bg-green-950/20 p-3">
                      <p className="text-sm font-medium text-foreground mb-1">
                        4. Ampliar programa de capacitação
                      </p>
                      <p className="text-xs text-muted-foreground">
                        Expandir o investimento em capacitação para atingir a
                        meta de 40h/ano por funcionário (atualmente{" "}
                        {(totalHorasCapacitacao / totalFuncionarios).toFixed(1)}
                        h). Priorizar programas de liderança, tecnologia e
              ...
              <AccordionItem value="projecoes">
                ...
                <AccordionContent>
                  <div className="space-y-4 pl-6">
                    <p className="text-sm text-muted-foreground">
                      Com base na tendência histórica e nas aposentadorias
                      projetadas, estima-se para o encerramento do exercício:
                    </p>
                    ...
                    <p className="text-xs text-muted-foreground italic">
                      * Projeções consideram reajuste salarial previsto,
                      aposentadorias e vagas em aberto.
                    </p>
                  </div>
                </AccordionContent>
              </AccordionItem>
              ...
              <div className="flex gap-3">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    A gestão de recursos humanos do município apresenta
                    indicadores positivos em retenção e custo médio por
                    servidor, com turnover de 8.5% e custo médio abaixo da média
                    regional. Os principais pontos de atenção são: (1) a
                    proximidade do limite de alerta da LRF com despesa de
                    pessoal em
                    {limitePessoalLRF.percentualAtual}% da RCL; (2) o excesso de
                    horas extras que supera o orçamento em 27.8%; e (3) o
                    absenteísmo elevado na Secretaria de Saúde. Recomenda-se
                    priorizar o planejamento de sucessão para as{" "}
                    {totalAposentadorias5Anos} aposentadorias projetadas e
                    ampliar os programas de capacitação e qualidade de vida.
                  </p>
